...
<body>
    ...
    <div class="table">
        <table>
            ...
            <%}}else if(req.equals("managestaff")) {
                StaffDA staffDA = new StaffCon();
                List<User> userList = new ArrayList<>();

                userList = staffDA.getAllStaff();
            %>
            <caption>Manage Staff</caption>
            <tr>
                <th>Id</th>
                <th>Role</th>
                <th>Name</th>
            ...
            <tr>
                ...
                <td><%=userList.get(i).getSubRole()%></td>
                <td><%=userList.get(i).getUser_firstName() + " " + userList.get(i).getUser_lastName()%></td>
                <td><%=userList.get(i).getUser_username()%></td>
                <td><%=userList.get(i).getUser_doj()%></td>
                <td><%=userList.get(i).getPhone()%></td>
                <td><%=userList.get(i).getEmail()%></td>
                <td><%=userList.get(i).getSalary()%></td>
                <td>
                    <a id = "update" href = "StaffUpdate.jsp?username=<%=userList.get(i).getUser_username()%>">Update</a>
                    <a id = "delete" href = "staffdel?sId=<%=userList.get(i).getUser_id()%>">Delete</a>
                </td>
            </tr>
            <%}%>
            <tr class="newStaff">
                <td colspan="9" style="text-align: center;"><a href = "StaffSignUp.jsp">Add New Staff</a></td>
            </tr>
