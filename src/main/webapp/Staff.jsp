...
<body>
    ...
    <div class="heading">
        <h1>Staff Page</h1><br><hr>
    </div><br><br>

    <div class="button-container">
        <a href="StaffProfile.jsp" class="button button2">Profile</a>
    </div><br>
    <div class="button-container">
        <a href="StaffTable?req=manageorder" class="button button1">Manage Order</a>
    </div><br>
    <div class="button-container">
        <a href="StaffTable?req=reservation" class="button button5">Manage Table Reservation</a>
    </div><br>
    <div class="button-container">
        <a href="StaffTable?req=stock" class="button button3">Manage Stock</a>
    </div><br>
    <div class="button-container">
